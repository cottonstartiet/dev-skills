<#
.SYNOPSIS
    Git worktree helper. Installed as the 'tr' command.
...
.EXAMPLE
    tr create wishlist-reorder-api
.EXAMPLE
    tr status
.EXAMPLE
    tr push -ConfirmBranch users/alice/wishlist-reorder-api
#>
[CmdletBinding()]
param(
...
function Invoke-Help {
    Write-Info @"
worktree.ps1 - git worktree helper (installed as 'tr')

Usage: tr <command> [name] [options]
