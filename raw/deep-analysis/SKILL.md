...
argument-hint: "Describe what you want analyzed (e.g., 'analyze the authentication flow in XPackageCore')"
---
...
1. Save the HTML report to a temporary location:
   ...
   - Use a descriptive filename like `xpackagecore-architecture-review.html`
